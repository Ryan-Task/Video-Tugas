...
<?php
    $jumlahdata = $db->rowCOUNT("SELECT idmenu FROM tbmenu ");
    $banyak = 3;
    ...
    $sql = "SELECT * FROM tbmenu  ORDER BY menu ASC LIMIT $mulai,$banyak";
    $row = $db->getALL($sql);
    // var_dump($row);
...
<div class="card" style="width: 15rem;float:left;margin: 10px;">
    ...
    <div class="card-body">
        ...
        <a type="button" class="btn btn-dark float-end" href="?f=kategori&m=insert">BELI</a>
